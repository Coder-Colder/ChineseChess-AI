...
public:
	...
	virtual void generateMovement(vector<MOVEMENT> &moveList, int board[10][9]) = 0; //生成所有的合法的走子位置
};
...
public:
	...
	void generateMovement(vector<MOVEMENT> &moveList, int board[10][9]); //重定义父类函数
};
